...
translations = {
    ...
    'te': {
        ...
        'ratingCommentHint': 'వ్యాఖ్యను జోడించండి (ఐచ్ఛిక)',
...
for i, line in enumerate(lines):
    ...
    if current_locale and line.strip() == "}," or (line.strip() == "}" and current_locale == 'pa'):
        ...
        if current_locale in translations:
            # We look backwards to see what's already there
            block = "".join(new_lines[-200:])
...
print('Updated translations in app_localizations.dart line by line')
